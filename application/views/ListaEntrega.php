...
<div  class= "jumbotron"  style=" color:#FFFFFF; background-color:#6EE768; text-align:center"> 
		<h1 style="font-size: 50pt">Lista Entrega</h1>
</div>
<div class="container">
	    	...
	    	if( $query != FALSE){
	            foreach ($query ->result() as $row){
			    	...
			    	echo "<div class='row'>";
			    		...
			    		echo "<div class='col-md-3' style='text-align:center'><a href='".base_url()."index.php/welcome/listoTodoE/".$row->folio."' class='btn btn-success btn-lg'><span class='glyphicon glyphicon-ok'></a></span></div>";
			  			echo "</form>";
			  		echo "</div>";
			  		echo "<div class='row'>";
			    		...
			    		echo "<div class='col-md-3' ><br><a href='".base_url()."".$row->archivo."'>".$row->archivo."</a></div>";
			  		echo "</div>";
			  		echo "<div class='row'>";
