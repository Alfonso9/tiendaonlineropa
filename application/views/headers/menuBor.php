  ...
  <div class="container">
    ...
    <div id="acolapsar" class="collapse navbar-collapse navbar-exit-collapse">
      ...
      <ul class="nav navbar-nav">        
		...
		<li <?php if ($activa == 'inventarioB'){ echo "class='active'"; } ?>>
			<a href="<?=base_url()?>index.php/Welcome/inventarioB">
				<span class="glyphicon glyphicon-th-list"></span>&nbsp;
				Actualizacion Del Material
			</a>
		</li>
		<li <?php if ($activa == 'lispBor'){ echo "class='active'"; } ?>>
			<a href="<?=base_url()?>index.php/Welcome/lispBor">
