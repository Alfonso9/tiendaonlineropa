	    	...
	    	if( $query != FALSE){
	            foreach ($query ->result() as $row){
			    	...
			    	echo "<div class='row'>";
			    		...
			    		echo "<div class='col-md-3' style='text-align:center'><a href='".base_url()."index.php/welcome/listoTodoB/".$row->folio."' class='btn btn-success btn-lg'><span class='glyphicon glyphicon-ok'></a></span></div>";
			    		echo "</form>";
			  		echo "</div>";
			  		echo "<div class='row'>";
			   			echo "<div class='col-md-1' style='text-align:center'><br><p>CÓDIGO:</p></div>";
			  		...
			  		echo "<div class='row'>";
			    		...
			    		foreach ($queryp2 ->result() as $rowp2){
			    			echo "<div class='col-md-10' ><br><p>".$rowp2->descrip." <b>Color:</b>".$rowp2->color." <b>Talla:</b>".$rowp2->talla." <b>Modelo:</b>".$rowp2->modelo." <b>Genero:</b>".$rowp2->genero."</p></div>";
			    		}
			  		echo "</div>"; 
			  		echo "</div>"; 
			  		echo "<br></br>";      
