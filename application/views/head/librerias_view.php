...
<head>
    ...
    <meta name="description" content="Proyecto LUXURY GALERRY para la materia de Administracion de Proyectos">
    <meta name="author" content="Andrea Prott & Alfonso Ramirez">
    <title>T-SHIRT & STAFF</title>
    <link rel="shorcut icon" href="<?=base_url();?>images/logo.png" type="image/x-icon">
