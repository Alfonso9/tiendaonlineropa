                    ...
                    if( $query != FALSE){
                        foreach ($query ->result() as $row) {
                                ...
                                echo "<td>".$row->cant_mat."</td>"; 
                                      echo "<td>";
                                      if($row->cant_mat <= 50){
                                        echo "<a href='".base_url()."index.php/welcome/editar/".$row->cod_mat."' class='label label-danger'>";
                                        echo "<span class='glyphicon glyphicon-pencil'></a></span>";
                                      }else if($row->cant_mat <= 100){
                                        echo "<a href='".base_url()."index.php/welcome/editar/".$row->cod_mat."' class='label label-warning'>";
                                        echo "<span class='glyphicon glyphicon-pencil'></a></span>";
                                      }else{
                                        echo "<a href='".base_url()."index.php/welcome/editar/".$row->cod_mat."' class='label label-success'>";
                                        echo "<span class='glyphicon glyphicon-pencil'></a></span>";
                                      }
                                      echo "</td>"; ?>
                            </tr>
